...
<div class="row">
  ...
  <div class="col-12 pt-4">
    <div class="col-6">
      <a class='btn btn-info' href="/ricemil/kasir/index.php?page=profile&modul=edit&user_id=<?php echo $row['user_id']; ?>">Edit</a>
      <a class='btn btn-danger' href="/ricemil/kasir/index.php?page=profile&modul=changepwd&user_id=<?php echo $row['user_id']; ?>">Change Password</a>
    </div>
  </div>
</div>
<!-- </form> -->