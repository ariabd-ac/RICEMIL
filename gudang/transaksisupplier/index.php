            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a class='btn btn-info' href="/ricemil/gudang/index.php?page=transaksisupplier&modul=edit&id=<?php echo $row['Id']; ?>&status=<?php echo $status ?>"><?php echo $statusList[$status + 1] ?></a>                            
                        </td>
                    </tr>
                <?php
                }
