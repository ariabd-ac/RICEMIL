...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE tb_transaksi SET status='$status' WHERE Id_transaksi='$id'";

    $insert = mysqli_query($conn, $query);
    if ($insert) {
        header('location:/ricemil/gudang/index.php?page=transaksi');
...
?>
        ...
        <form action="" method="post" class='row'>
            ...
            <div class="form-group">
                ...
                <input type="submit" class='btn btn-success' name='submit' value='Dikirim' class='form-control'>
            </div>
            <?php } ?>
            ...
            <div class="form-group">
                ...
                <input type="submit" class='btn btn-success' name='submit' value='Tandai Telah Selesai' class='form-control'>
            </div>
            <?php } ?>
        </form>
