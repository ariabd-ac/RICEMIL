        ...
        <table class="table user-table">
            ...
            <tbody>
                ...
                $query = "SELECT * FROM tb_pengadaan_stock TPS
                        WHERE TPS.supplier_nohp=(SELECT phone FROM users WHERE unique_id='$_SESSION[unique_id]') AND TPS.is_approve='1'";
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a class='btn btn-info' href="/ricemil/supplier/index.php?page=transaksi&modul=edit&id=<?php echo $row['Id']; ?>&status=<?php echo $status ?>">Detail</a>                            
                        </td>
                    </tr>
                <?php
                }
