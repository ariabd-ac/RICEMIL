        ...
        <table class="table user-table">
            ...
            <tbody>
                ...
                $query = "SELECT 
                        ...
                        FROM tb_barang
                        LEFT JOIN tb_harga_supplier ON tb_harga_supplier.id_item=tb_barang.Id_barang";
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $row['hargaSupplier'] ?></td>
                        <!-- <td><?php echo $row['stock'] ? $row['stock'] : 0 ?></td> -->
                        <td>
                            <a class='btn btn-info' href="/ricemil/supplier/index.php?page=databarang&modul=edit&id=<?php echo $row['Id_barang']; ?>">Edit</a>
